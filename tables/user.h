...
public:
    ...
    inline bool Insert()     
    {
        ...
        " values ({}, {}, {}, {}, {}, {}, {}, {}, {})", P(m_nUserId), P(m_szUsername), P(m_szPhone), P(m_cIdType), P(m_szIdNumber), P(m_szAddress), P(m_nBirthday), P(m_cSex), P(m_nCreateData));
        strm.Exec();
    ...
    inline bool Update()     
    {
        ...
        " where USER_ID = {} ", P(m_szUsername), P(m_szPhone), P(m_cIdType), P(m_szIdNumber), P(m_szAddress), P(m_nBirthday), P(m_cSex), P(m_nCreateData), P(m_nUserId));
        strm.Exec();
